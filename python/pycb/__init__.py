...
"""
    ...
    def load_settings(self):
        config_path = []
        config_path.append("/opt/nimbus/cumulus/etc/cumulus.ini")
        ...
        for cp in config_path:
            ...
            try:
                self.backend = s.get("backend", "type")
                ...
                elif self.backend == "hdfs":
                    name_node = s.get("backend","name_node")
                    self.bucket = HDFS(name_node)
                    block_size = s.get("backend", "block_size")
            except:
                pass
