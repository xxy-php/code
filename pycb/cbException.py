...
class cbException(Exception):
    ...
    def __str__(self):
        pycb.log(logging.INFO, "===== def __str__ of cbException.py")
        return self.eMsg

    def getCode(self):
        pycb.log(logging.INFO, "===== def getCode of cbException.py")
        return self.code

    def add_custom_xml(self, k, v):
        pycb.log(logging.INFO, "===== def add_custom_xml of cbException.py")
        self.custom_xml[k] = v

    def make_xml_string(self, path, requestId):
        pycb.log(logging.INFO, "===== def make_xml_string of cbException.py")
        doc = Document()
    ...
    def sendErrorResponse(self, request, requestId):
        pycb.log(logging.INFO, "===== def sendErrorResponse of cbException.py")
